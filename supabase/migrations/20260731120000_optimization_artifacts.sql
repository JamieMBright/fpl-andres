create table public.optimization_runs (
    ...
    price_scenario text check (
        price_scenario is null or price_scenario = 'provided_event_prices'
    ),
    ...
    public_source_hashes text[] not null check (cardinality(public_source_hashes) > 0),
    ...
    constraint optimization_runs_price_scenario check (
        (plan_kind = 'quick' and price_scenario is null)
