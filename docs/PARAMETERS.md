...
| current-plus-carried xStart | off   | `experiments/xstart.py`    | Production-disabled harness. Hosted train/holdout evidence must promote it before any production model can enable it.                                                                                                                                                                                                                                                    |
