...
| ------- | ----- | ------- | -------- | ------- | ---------- | ----- | ----- | ------ |
| 2022-23 | 1.734 | −10.6%  | 0.500    | +0.053  | 0.179      | 0.148 | 0.176 | −0.223 |
| 2023-24 | 1.708 | −8.7%   | 0.515    | +0.052  | 0.205      | 0.170 | 0.177 | −0.131 |
| 2024-25 | 1.665 | −8.4%   | 0.513    | +0.047  | 0.197      | 0.142 | 0.166 | −0.137 |
| 2025-26 | 1.851 | −7.7%   | 0.470    | +0.048  | 0.158      | 0.116 | 0.136 | −0.122 |
...
| ------- | ------------- | ----- | ------- | -------------- | ----------- | --------- | ------- |
| 2022-23 | `model`       | 31    | 7.23    | 15.45          | 8.23        | 2         | 0.32    |
| 2022-23 | `components`  | 31    | 6.32    | 15.45          | 9.13        | 2         | 0.32    |
...
| 2024-25 | `model`       | 32    | 8.91    | 14.53          | 5.62        | 10        | 0.28    |
| 2024-25 | `components`  | 32    | 9.22    | 14.53          | 5.31        | 11        | 0.25    |
| 2024-25 | `recent_mean` | 32    | 7.25    | 14.53          | 7.28        | 6         | 0.31    |
| 2024-25 | `ownership`   | 32    | 7.78    | 14.53          | 6.75        | 8         | 0.38    |
| 2025-26 | `model`       | 32    | 5.38    | 13.50          | 8.12        | 4         | 0.44    |
| 2025-26 | `components`  | 32    | 4.91    | 13.50          | 8.59        | 4         | 0.50    |
...
| ----------------------- | ------------------- | ------------------ | ---------------------- |
| `availability_adjusted` | 7.13                | 1                  | +0.23 [-0.37, +0.93]   |
| `template`              | 7.06                | 0                  | +0.16 [-0.47, +0.96]   |
| `expected_points`       | 6.90                | 0                  | baseline               |
| `differential`          | 6.62                | 1                  | -0.27 [-1.26, +0.69]   |
| `components`            | 6.44                | 1                  | -0.46 [-1.39, +0.44]   |
| `ceiling_and_fixture`   | 6.41                | 1                  | -0.50 [-1.92, +0.98]   |
| `crowd`                 | 6.37                | 0                  | -0.53 [-1.87, +1.00]   |
| `robust`                | 6.11                | 0                  | -0.80 [-2.10, +0.59]   |
| `upside`                | 5.74                | 0                  | -1.17 [-2.69, +0.36]   |
| `form`                  | 5.38                | 0                  | -1.51 [-3.01, -0.13]   |
| `set_and_forget`        | 4.24                | 0                  | -2.65 [-4.46, -0.94]   |
