...
| 2025-26 | 540   | 5.27   | 12.18        | 6.91         | 80        | 0.47    |
...
| ----------------------- | ------------------- | ------------------ | ---------------------------- |
| `template`              | 7.41                | 0                  | +0.42 [+0.24, +0.59] **yes** |
| `expected_points`       | 6.91                | 0                  | baseline                     |
| `differential`          | 6.89                | 1                  | -0.19 [-0.47, +0.08]         |
| `crowd`                 | 6.87                | 2                  | -0.15 [-0.48, +0.18]         |
| `components`            | 6.81                | 1                  | -0.26 [-0.50, -0.02]         |
| `availability_adjusted` | 6.76                | 0                  | -0.17 [-0.29, -0.07]         |
| `set_and_forget`        | 6.62                | 1                  | -0.34 [-0.72, +0.00]         |
| `upside`                | 6.43                | 0                  | -0.56 [-0.86, -0.27]         |
| `robust`                | 6.11                | 0                  | -0.97 [-1.28, -0.62]         |
| `ceiling_and_fixture`   | 5.45                | 0                  | -1.59 [-1.93, -1.22]         |
| `form`                  | 5.27                | 0                  | -1.71 [-2.02, -1.42]         |
