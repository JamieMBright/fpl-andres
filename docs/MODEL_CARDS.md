...
| ------- | ----- | ------ | ------------ | ------------ | --------- | ------- |
| 2022-23 | 650   | 7.81   | 13.00        | 5.19         | 150       | 0.27    |
| 2023-24 | 680   | 8.20   | 14.47        | 6.27         | 220       | 0.18    |
| 2024-25 | 325   | 6.37   | 13.23        | 6.86         | 65        | 0.31    |
| 2025-26 | 715   | 5.16   | 11.96        | 6.80         | 90        | 0.42    |
...
| ----------------------- | ------------------- | ------------------ | ---------------------------- |
| `template`              | 7.22                | 0                  | +0.23 [+0.06, +0.40] **yes** |
| `expected_points`       | 6.88                | 0                  | baseline                     |
| `differential`          | 6.82                | 1                  | -0.23 [-0.48, +0.00]         |
| `components`            | 6.76                | 2                  | -0.23 [-0.47, -0.01]         |
| `availability_adjusted` | 6.69                | 0                  | -0.24 [-0.35, -0.14]         |
| `crowd`                 | 6.56                | 1                  | -0.43 [-0.75, -0.07]         |
| `upside`                | 6.36                | 0                  | -0.59 [-0.86, -0.32]         |
| `set_and_forget`        | 6.33                | 1                  | -0.60 [-0.94, -0.25]         |
| `robust`                | 6.12                | 0                  | -0.89 [-1.18, -0.60]         |
| `ceiling_and_fixture`   | 5.31                | 0                  | -1.59 [-1.91, -1.29]         |
| `form`                  | 5.21                | 0                  | -1.68 [-1.97, -1.40]         |
