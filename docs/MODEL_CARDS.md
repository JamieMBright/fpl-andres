...
| ------- | ----- | ------- | -------- | ------- | ---------- | ----- | ----- | ------ |
| 2022-23 | 1.740 | −10.3%  | 0.499    | +0.052  | 0.181      | 0.148 | 0.176 | −0.205 |
| 2023-24 | 1.711 | −8.6%   | 0.514    | +0.051  | 0.205      | 0.170 | 0.177 | −0.125 |
| 2024-25 | 1.665 | −8.3%   | 0.512    | +0.046  | 0.197      | 0.142 | 0.166 | −0.134 |
| 2025-26 | 1.852 | −7.7%   | 0.470    | +0.048  | 0.156      | 0.116 | 0.136 | −0.119 |
...
| 2022-23 | `components`  | 31    | 6.07    | 15.45          | 9.39        | 2         | 0.35    |
...
| 2025-26 | `components`  | 32    | 4.88    | 13.50          | 8.62        | 4         | 0.50    |
...
| ----------------------- | ------------------- | ------------------ | ---------------------- |
| `availability_adjusted` | 7.12                | 1                  | +0.22 [-0.38, +0.91]   |
| `template`              | 7.06                | 0                  | +0.16 [-0.47, +0.96]   |
| `expected_points`       | 6.90                | 0                  | baseline               |
| `differential`          | 6.77                | 1                  | -0.13 [-1.11, +0.83]   |
| `ceiling_and_fixture`   | 6.41                | 1                  | -0.50 [-1.92, +0.98]   |
| `crowd`                 | 6.37                | 0                  | -0.53 [-1.87, +1.00]   |
| `components`            | 6.37                | 1                  | -0.53 [-1.46, +0.38]   |
| `robust`                | 5.99                | 0                  | -0.91 [-2.28, +0.50]   |
| `upside`                | 5.71                | 0                  | -1.20 [-2.75, +0.32]   |
