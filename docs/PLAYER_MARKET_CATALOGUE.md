...
Surveyed 2026-08-16 17:51 UTC. 5 of 6 sources answered; 2 of those price a scoring market.
...
- **API-Football** — goal, assist, yellow_card, red_card, clean_sheet, defensive_contribution. Credentials: `API_FOOTBALL_API_KEY`. Free tier, 100 requests a day.
...
| API-Football         | answered (200) | yes  | yes    | yes         | —    | —            | —              | yes         | yes      | —        | —            | yes                    | —     |
...
- Status: answered (200) — Arsenal v Coventry City on 2026-08-21T19:00:00Z; 21 books, 156 outcomes; asked for 11 markets, 8 absent (player_assists, player_first_goal_scorer, player_goal_scorer_anytime, player_last_goal_scorer, player_shots, player_shots_on_target, player_to_receive_card, player_to_receive_red_card); cost 4, 424 left
- Markets named (4):
  - `alternate_totals`
  - `h2h`
  - `h2h_lay`
...
- Status: answered (200) — 14515 bytes; 332 bet types listed; no Premier League fixture scheduled; 98 left
- Markets named (332):
  - `10 Over/Under`
  - `1x2 - 15 minutes`
  - `1x2 - 20 minutes`
  ...
  - `Away Player Tackles`
  - `Away Player to Score or Assist`
  - `Away Shots On Target`
  - `Away Team Exact Goals Number`
  - `Away Team Goalscorers First`
  - `Away Team Goalscorers Last`
  - `Away Team Score a Goal`
  - `Away Team Score a Goal (1st Half)`
  - `Away Team Score a Goal (2nd Half)`
  - `Away Team Total Cards`
  - `Away Team Total Goals(1st Half)`
  - `Away Team Total Goals(2nd Half)`
  - `Away Team Yellow Cards`
  - `Away To Score Three or More Goals`
  - `Away To Score Two or More Goals`
  - `Away Total Corners (1st Half)`
  - `Away Total Corners (2nd Half)`
  - `Away Total ShotOnGoal`
  - `Away Win To Nill (1st Half)`
  - `Away Win To Nill (2nd Half)`
  - `Away Win/Over`
  - `Away Win/Under`
  - `Away Winning Margin (1st Set)`
  ...
  - `First Goal Scorer`
  - `First Half Winner`
  - `First Set Piece 5 Minutes`
  - `First Team to Score`
  - `First Team to Score (3 way) 1st Half`
  - `First Team to Score (3 way) 2nd Half`
  - `Fouls Odd/Even`
  - `Fouls. 1x2`
  - `Fouls. Away Total`
  - `Fouls. Double Chance`
  ...
  - `Home Anytime Goal Scorer`
  - `Home Come From Behind and Draw`
  - `Home Come From Behind and Win`
  - `Home Corners Over/Under`
  - `Home Exact Goals Number (1st Half)`
  - `Home First Goal Scorer`
  - `Home Goal Method Header`
  - `Home Goal Method Outside the Box`
  - `Home Goalkeeper Saves`
  - `Home Highest Scoring Half`
  - `Home Last Goal Scorer`
  - `Home No Bet`
  - `Home Not lose/Over`
  - `Home Not lose/Under`
  - `Home Odd/Even`
  ...
  - `Home Player Tackles`
  - `Home Player to Score or Assist`
  - `Home Shots On Target`
  - `Home Team Exact Goals Number`
  - `Home Team Goalscorers First`
  - `Home Team Goalscorers Last`
  - `Home Team Score a Goal`
  - `Home Team Score a Goal (1st Half)`
  ...
  - `Home To Score Three or More Goals`
  - `Home To Score Two or More Goals`
  - `Home Total Corners (1st Half)`
  - `Home Total Corners (2nd Half)`
  - `Home Total ShotOnGoal`
  - `Home Win To Nill (1st Half)`
  - `Home Win To Nill (2nd Half)`
  - `Home Win/Over`
  - `Home Win/Under`
  - `Home Winning Margin (1st Set)`
  ...
  - `Match Winner`
  - `Method of Victory`
  - `Multi Touchdown Scorer (2 or More)`
  - `Multi Touchdown Scorer (3 or More)`
  - `Multicorners`
  ...
  - `RTG_H1`
  - `Race To`
  - `Race to the 2nd goal?`
  - `Race to the 3rd goal?`
  ...
  - `Tackles. Away Total`
  - `Tackles. Home Total`
  - `Team Goalscorers First`
  - `Team Goalscorers Last`
