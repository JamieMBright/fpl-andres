...
Surveyed 2026-08-24 07:42 UTC. 4 of 6 sources answered; 1 of those price a scoring market.
...
| -------------------- | -------------- | ---- | ------ | ----------- | ---- | ------------ | -------------- | ----------- | -------- | -------- | ------------ | ---------------------- | ----- |
| The Odds API         | refused (401)  | yes  | yes    | —           | —    | —            | —              | yes         | yes      | —        | —            | —                      | —     |
...
- Status: answered (200) — 14515 bytes; 332 bet types listed; fixtures refused: plan: Free plans do not have access to this season, try from 2022 to 2024.; 99 left
- Markets named (332):
  - `10 Over/Under`
  - `1x2 - 15 minutes`
  - `1x2 - 20 minutes`
...
- Status: answered (200) — 18688 bytes; embedded datasets: BASE_URL, THEME, flagFontsLoading, j
...
- Status: answered (200) — 609 elements
