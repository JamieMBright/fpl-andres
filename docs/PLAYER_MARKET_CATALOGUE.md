...
Surveyed 2026-08-10 09:19 UTC. 5 of 6 sources answered; 2 of those price a scoring market.
...
- **API-Football** — goal, assist, yellow_card, red_card, clean_sheet. Credentials: `API_FOOTBALL_API_KEY`. Free tier, 100 requests a day.
...
| API-Football         | answered (200) | yes  | yes    | yes         | —    | —            | —              | yes         | yes      | —        | —            | —                      | —     |
...
- Status: answered (200) — 14515 bytes; 332 bet types listed; no Premier League fixture scheduled; 95 left
- Markets named (332):
  - `10 Over/Under`
  - `1x2 - 15 minutes`
  - `1x2 - 20 minutes`
...
- Status: answered (200) — 573 elements
