...
Surveyed 2026-08-21 08:20 UTC. 5 of 6 sources answered; 2 of those price a scoring market.
...
- **API-Football** — goal, assist, save, yellow_card, red_card, clean_sheet. Credentials: `API_FOOTBALL_API_KEY`. Free tier, 100 requests a day.
...
- Status: answered (200) — Arsenal v Coventry City on 2026-08-21T19:00:00Z; 21 books, 800 outcomes; asked for 11 markets, 1 absent (player_shots); cost 11, 3 left
- Markets named (11):
  - `alternate_totals`
  - `h2h`
  - `h2h_lay`
...
- Status: answered (200) — 14515 bytes; 332 bet types listed; fixtures refused: plan: Free plans do not have access to this season, try from 2022 to 2024.; 98 left
- Markets named (332):
  - `10 Over/Under`
  - `1x2 - 15 minutes`
  - `1x2 - 20 minutes`
...
- Status: answered (200) — 599 elements
