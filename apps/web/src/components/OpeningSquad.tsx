  ...
  return (
    <section className="opening-squad" aria-labelledby="opening-title">
      ...
      <p className="opening-basis">
        ...
        than three from a club. Chosen to maximise the <em>starting eleven</em>,
        because that is all that scores, with a bench that can actually play so
        an absence does not cost you a transfer.
      </p>
            ...
            {byPosition.flatMap((group) =>
              group.picks.map((pick) => (
                ...
                >
                  ...
                  <td className="mono">{Math.round(pick.startRate * 100)}%</td>
                  <td className="mono">
