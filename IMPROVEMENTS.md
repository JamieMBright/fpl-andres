...
| A19 | 6     | Do             | `MethodFlow` is written for someone who already knows what a shrinkage prior is, and every worked example is the same player. It should read for a non-statistician, use a different player at each step, and expand into charts -- route contributions, a difficulty scale, a floor-median-ceiling range -- rather than more prose.                                                                                                                                                                                                                                                                                         |
